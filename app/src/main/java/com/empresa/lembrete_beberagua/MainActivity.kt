package com.empresa.lembrete_beberagua
...
import com.empresa.lembrete_beberagua.model.CalcularIngestaoDiaria
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.hide() //esconder a barra de ação
